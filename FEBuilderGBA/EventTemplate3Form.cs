...
{
    public partial class EventTemplate3Form : Form
    {
        public EventTemplate3Form()
        {
            InitializeComponent();
        ...
        private void EventCondEventTemplate3Form_Load(object sender, EventArgs e)
        {
        ...
        private void TalkEvent_button_Click(object sender, EventArgs e)
        {
            this.GenCode = EventScriptInnerControl.ConverteventTextToBin(U.ConfigDataFilename("template_event_TalkEvent_"));
            this.Close();
        }

        private void EnemyReinforcement_button_Click(object sender, EventArgs e)
        {
            this.GenCode = EventScriptInnerControl.ConverteventTextToBin(U.ConfigDataFilename("template_event_EnemyReinforcement_"));
            this.Close();
        }

        private void EnemyReinforcementIfHard_button_Click(object sender, EventArgs e)
        {
            this.GenCode = EventScriptInnerControl.ConverteventTextToBin(U.ConfigDataFilename("template_event_EnemyReinforcementIfHard_"));
            this.Close();
        }
