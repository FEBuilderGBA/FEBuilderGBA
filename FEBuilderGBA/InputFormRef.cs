...
//                    Debug.Assert(false);
        ...
        public static string GetExplain(string str)
        {
            ...
            {
                str = R._("難易度で普通を選んだ場合に、敵を弱くするペナルティ値を指定します。\r\nペナルティを設定する場合は、レベルがマイナスにならないように注意してください。\r\nレベルがマイナスになると、アンダーフローが発生し、敵が最強になってしまいます。\r\n通常は0を設定し、ペナルティを無効にすることを推奨します。\r\n");
            }
            ...
            else if (str == "@EXPLAIN_MOVEMENTCOST_BARISTAICON")
            {
                str = R._("バリスタに乗っている時の移動コストを指定します。。\r\n");
            }
