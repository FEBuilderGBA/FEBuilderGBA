    ...
    public class MagicSplitUtil
    {
        ...
        static magic_split_enum SearchMagicSplitLow()
        {
            PatchUtil.PatchTableSt[] table = new PatchUtil.PatchTableSt[] { 
                ...
                new PatchUtil.PatchTableSt{ name="FE8UMAGIC",	ver = "FE8U", addr = 0x17E5C,data = new byte[]{0x01 ,0x4B ,0xB9 ,0xF0 ,0x35 ,0xFD}}, //魔力分離パッチ FE8U 2022年以降
            };
        ...
        static void FE8UInit()
        {
            ...
            {
                //2022年以降は以下のように変更された
                byte[] bin = { 0x08, 0x79, 0x0B, 0x4B, 0x40, 0x00, 0xC0, 0x18, 0x00, 0x23, 0xC0, 0x56, 0x15, 0x79, 0xAD, 0x00, 0x08, 0x4B, 0xED, 0x18, 0x00, 0x23, 0xED, 0x56, 0x40, 0x19, 0x23, 0x1C, 0x3A, 0x33, 0x18, 0x70, 0x00, 0x23, 0xD0, 0x7B, 0x0D, 0x7C, 0x40, 0x19, 0xE0, 0x75, 0x10, 0x7C, 0x4A, 0x7C, 0x70, 0x47 };
                p = U.GrepEnd(Program.ROM.Data, bin, Program.ROM.RomInfo.compress_image_borderline_address, 0, 4, 0, true);
                if (U.isSafetyOffset(p))
                {
                    UnitTag = Program.ROM.p32(p);
