...
namespace FEBuilderGBA
{
    sealed class ROMFE0 : IROMFEINFO
    {
        ...
        public uint map_map_pointer_list_default_size() { return 0x0; } //PLIST拡張をしていない時のバニラでのPLISTの数
        ...
        public uint menu_item_pointer() { return 0x0; }  // アイテム利用メニュー
        ...
        public uint workmemory_keybuffer_address() { return 0x0; } //RAMのキーバッファ
        public uint procs_maptask_pointer() { return 0x0; } //PROCSのMAPTASK 
        public uint procs_soundroomUI_pointer() { return 0x0; } //PROCSのSoundRoomUI 
        ...
        public uint map_minimap_tile_array_pointer() { return 0; } //minimapのチップ割り当て
