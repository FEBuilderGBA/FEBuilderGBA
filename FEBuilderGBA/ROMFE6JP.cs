...
namespace FEBuilderGBA
{
    sealed class ROMFE6JP : IROMFEINFO
    {
        ...
        public uint map_map_pointer_list_default_size() { return 0xe5; } //PLIST拡張をしていない時のバニラでのPLISTの数
        ...
        public uint menu_item_pointer() { return 0x5C7554; }  // アイテム利用メニュー
        ...
        public uint systemmenu_badstatus_old_palette_pointer() { return 0x6388; } //昔の圧縮のバッドステータス画像のパレット FE7 FE6
        ...
        public uint RAMSlotTable_address() { return 0x5C5280; }
        public uint supply_pointer_address() { return 0x296A8; }  //輸送体RAMへのアドレス
        ...
        public uint workmemory_chapterdata_size() { return 0x20; }    //ワークメモリ 章データのサイズ
        public uint workmemory_battle_actor_address() { return 0x02039214; } //ワークメモリ 戦闘時のユニット構造体
        public uint workmemory_battle_target_address() { return 0x02039290; } //ワークメモリ 戦闘時のユニット構造体
        ...
        public uint workmemory_arena_data_address() { return 0x02039504; }//ワークメモリ 闘技場関係の起点
        public uint workmemory_ai_data_address() { return 0x02039600; } //ワークメモリ AI関係の起点
        ...
        public uint workmemory_keybuffer_address() { return 0x02023B20; } //RAMのキーバッファ
        public uint procs_maptask_pointer() { return 0x2911C; } //PROCSのMAPTASK 
        public uint procs_soundroomUI_pointer() { return 0x8BD68; } //PROCSのSoundRoomUI 
        ...
        public byte[] Default_event_script_term_code() { return new byte[] { 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; } //イベント命令を終了させるディフォルトコード
        public byte[] Default_event_script_toplevel_code() { return new byte[] { 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; } //イベント命令を終了させるディフォルトコード(各章のトップレベルのイベント)
        public byte[] Default_event_script_mapterm_code() { return new byte[] { 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; } //ワールドマップイベント命令を終了させるディフォルトコード
        ...
        public uint vanilla_field_config_address() { return 0x23956C; }    //バニラのタイルセット よく使われもの
        public uint vanilla_field_image_address() { return 0x2478F0; }
        public uint vanilla_village_config_address() { return 0x2384F8; }
        public uint vanilla_village_image_address() { return 0x222628; }
        public uint vanilla_casle_config_address() { return 0x2365F4; }
        public uint vanilla_casle_image_address() { return 0x219DEC; }
        public uint vanilla_plain_config_address() { return 0x22A6A4; }
        public uint vanilla_plain_image_address() { return 0x1E3F54; }
        public uint map_minimap_tile_array_pointer() { return 0x86E14; } //minimapのチップ割り当て
        public uint bg_reserve_black_bgid() { return U.NOT_FOUND; }
        public uint bg_reserve_random_bgid(){ return U.NOT_FOUND; }
