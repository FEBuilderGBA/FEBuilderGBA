...
namespace FEBuilderGBA
{
    sealed class ROMFE7JP : IROMFEINFO
    {
        ...
        public uint map_map_pointer_list_default_size() { return 0xFC; } //PLIST拡張をしていない時のバニラでのPLISTの数
        ...
        public uint terrain_show_infomation_pointer() { return 0x85F78; } //地形ウィンドウに情報表示 全クラス共通
        ...
        public uint menu_item_pointer() { return 0xC04C98; }  // アイテム利用メニュー
        ...
        public uint workmemory_battleround_data_address() { return 0x0203A508; } //ワークメモリ　戦闘のラウンドデータ
        ...
        public uint procs_maptask_pointer() { return 0x2E644; } //PROCSのMAPTASK 
        public uint procs_soundroomUI_pointer() { return 0xAD1A0; } //PROCSのSoundRoomUI 
        ...
        public uint vanilla_field_config_address() { return 0x35FC08; }    //バニラのタイルセット よく使われもの
        public uint vanilla_field_image_address() { return 0x371394; }
        public uint vanilla_village_config_address() { return 0x362308; }
        public uint vanilla_village_image_address() { return 0x344F94; }
        public uint vanilla_casle_config_address() { return 0x36381C; }
        public uint vanilla_casle_image_address() { return 0x34C1BC; }
        public uint vanilla_plain_config_address() { return 0x364ADC; }
        public uint vanilla_plain_image_address() { return 0x352418; }
        public uint map_minimap_tile_array_pointer() { return 0xA30F0; } //minimapのチップ割り当て
