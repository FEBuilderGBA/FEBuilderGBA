...
namespace FEBuilderGBA
{
    sealed class ROMFE7U : IROMFEINFO
    {
        ...
        public uint map_map_pointer_list_default_size() { return 0xF7; } //PLIST拡張をしていない時のバニラでのPLISTの数
        ...
        public uint terrain_show_infomation_pointer() { return 0x85578; } //地形ウィンドウに情報表示 全クラス共通
        ...
        public uint ed_1_pointer() { return 0xB7EDC; }  //ED FE8のみ 倒れたら撤退するかどうか
        ...
        public uint workmemory_battleround_data_address() { return 0x02039328; } //ワークメモリ　戦闘のラウンドデータ
        ...
        public uint workmemory_keybuffer_address() { return 0x02024C78; } //RAMのキーバッファ
        public uint procs_maptask_pointer() { return 0x2E184; } //PROCSのMAPTASK 
        public uint procs_soundroomUI_pointer() { return 0xAC2BC; } //PROCSのSoundRoomUI 
        ...
        public byte[] Default_event_script_term_code() { return new byte[] { 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; } //イベント命令を終了させるディフォルトコード
        public byte[] Default_event_script_toplevel_code() { return new byte[] { 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; } //イベント命令を終了させるディフォルトコード(各章のトップレベルのイベント)
        public byte[] Default_event_script_mapterm_code() { return new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }; } //ワールドマップイベント命令を終了させるディフォルトコード
        ...
        public uint vanilla_field_config_address() { return 0x359F3C; }    //バニラのタイルセット よく使われもの
        public uint vanilla_field_image_address() { return 0x36B01C; }
        public uint vanilla_village_config_address() { return 0x35C63C; }
        public uint vanilla_village_image_address() { return 0x33F2C8; }
        public uint vanilla_casle_config_address() { return 0x35DB50; }
        public uint vanilla_casle_image_address() { return 0x3464F0; }
        public uint vanilla_plain_config_address() { return 0x35EE10; }
        public uint vanilla_plain_image_address() { return 0x34C74C; }
        public uint map_minimap_tile_array_pointer() { return 0xA247C; } //minimapのチップ割り当て
        public uint bg_reserve_black_bgid() { return 0x5b; }
