    ...
    public partial class SkillConfigSkillSystemForm : Form
    {
        ...
        static uint FindSkillPointer(string type, uint skip)
        {
            SkillSystemsTableSt[] table = new SkillSystemsTableSt[] { 
                ...
                new SkillSystemsTableSt{ name="ICON", skip =	0, data = new byte[]{0x38 ,0x00 ,0x00 ,0xF0 ,0xFB ,0xF9,0x80 , 0x22, 0x0E ,0x49 ,0x16 ,0x48 ,0x16 ,0x4B ,0xFF ,0xFF ,0xFF ,0xFF ,0x2B ,0x34 ,0x29 ,0x00 ,0x38 ,0x00 ,0x14 ,0x4B ,0xFF ,0xFF ,0xFF ,0xFF ,0x26 ,0x70 ,0xF8 ,0xBC ,0x01, 0xBC, 0x00, 0x47, 0x01, 0x33, 0xCD, 0xE7, 0xC0, 0x46}},
