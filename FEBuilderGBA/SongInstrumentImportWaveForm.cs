...
{
    public partial class SongInstrumentImportWaveForm : Form 
    {
        public SongInstrumentImportWaveForm()
        {
            InitializeComponent();
        ...
        private void ImportButNoChange_Click(object sender, EventArgs e)
        {
            this.DialogResult = System.Windows.Forms.DialogResult.OK;
            this.Close();
        }
