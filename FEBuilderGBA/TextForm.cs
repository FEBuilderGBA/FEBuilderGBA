...
//            Debug.Assert(g_GetDataCount_Cache > 0x100);
        ...
        public static string CheckSystemTextMessage(string text)
        {
            ...
            string[] no_words = new string[] { "@0008", "@0009", "@000A", "@000B", "@000C", "@000D", "@000E", "@000F", "@0010", "@0080@000A", "@0080@000B", "@0080@000C", "@0080@000D", "@0080@000E", "@0080@000F", "@0080@0010", "@0080@0011", "@0080@0016", "@0080@0018", "@0080@0019", "@0080@001B", "@0080@001C", "@0080@001D", "@0080@001E","@0018" };///No Translate
