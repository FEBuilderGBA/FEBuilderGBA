...
push {r1}
push {r2}
@ldr r1,=#0x0203A3F0 @ pointer to attacker data @FE7U
ldr  r1,=#0x0203A3EC @ pointer to attacker data @FE7J
cmp r1,r7
beq Compute
@ldr r1,=#0x0203A470 @ pointer to defender data @FE7U
ldr r1, =#0x0203A46C @ pointer to defender data @FE7J
cmp r1,r7
bne Return
...
.align 4
ReturnTo:
@.long 0x080295F4|1 @FE7U BUG?
@@.long 0x080295F0|1 @FE7U
.long  0x08029AA0|1 @FE7J
