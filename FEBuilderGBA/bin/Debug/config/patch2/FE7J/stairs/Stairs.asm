...
ldr r0, =#0x0202BBF4 @ Chapter data struct
ldrb r0, [ r0, #0x0E ] @ Chapter ID
blh #0x08031AEC, r1 @ Pointer to chapter events in r0
ldr r2, [ r0, #0x08 ] @ Pointer to location events in r2
sub r2, #12

ldr r0, =#0x0203A858 @ Action struct	//
...
ldr r4, =#0x030045B0	//
ldr r4, [ r4 ]
ldr r2, =#0x0203A858 @ Action struct	//
strb r0, [ r2, #0x0E ]
...
FixWait2: @ Autohook to 0x08018634 ; GOOD FOR FE7	//
cmp r0, #0x00
...
MoveDebuff: @ Autohook to 0x0801C8D4 ; GOOD FOR FE7	//
push { r4 - r6, lr }
mov r6, r0
mov r4, #0x01
ldr r5, =#0x030045B0	//
...
ldr r0, =#0x08C02630 @ From vanilla
blh #0x08004748, r1
mov r0, #0x17
pop { r1 }
bx r1
...
.global RepointThatAction
.type RepointThatAction, %function
RepointThatAction:
mov r0, r5
blh #0x0802D00C, r2
mov r0, #0x00
