...
A note to wizards: The old range-writing functions were hideously bloated, meaning I managed to stick all my stuff in-line and have some space left over. If you need more for BL-jumps, you can repoint everything after a certain point (which is clearly indicated) in the EA file to free space, thus freeing up even more room. Since FE7 doesn't have (to my knowledge) FE6 credits or any other convenient place to stick longcalls, this should work nicely, saving you from having to repoint the peg knight graphics.
