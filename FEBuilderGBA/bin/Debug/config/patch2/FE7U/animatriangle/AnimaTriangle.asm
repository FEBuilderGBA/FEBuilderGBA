...
ldr r0, =#0x0203A3F0 @ Attack struct
mov r1, #0x53
mov r2, #10      @ 10 for hit advantage
strb r2, [ r0, r1 ]
mov r1, #0x54
mov r2, #1      @ 1 for damage advantage
strb r2, [ r0, r1 ]

ldr r0, =#0x0203A470 @ Defense struct
mov r1, #0x53
mov r2, #0xF6      @ -10 for hit disadvantage
strb r2, [ r0, r1 ]
mov r1, #0x54
mov r2, #0xFF      @ -1 for damage disadvantage
strb r2, [ r0, r1 ]
b End
