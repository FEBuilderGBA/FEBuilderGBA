...
blh #0x080315BC, r1 @ Pointer to chapter events in r0
ldr r2, [ r0, #0x08 ] @ Pointer to location events in r2
sub r2, #12

ldr r0, =#0x0203A85C @ Action struct
...
ldr r4, =#0x03004690
ldr r4, [ r4 ]
ldr r2, =#0x0203A85C @ Action struct
strb r0, [ r2, #0x0E ]
...
FixWait2: @ Autohook to 0x08018244 ; GOOD FOR FE7
cmp r0, #0x00
...
MoveDebuff: @ Autohook to 0x0801C4D0 ; GOOD FOR FE7
push { r4 - r6, lr }
mov r6, r0
mov r4, #0x01
ldr r5, =#0x03004690
...
ldr r0, =#0x08B93374 @ From vanilla
blh #0x0800486C, r1
mov r0, #0x17
pop { r1 }
bx r1
