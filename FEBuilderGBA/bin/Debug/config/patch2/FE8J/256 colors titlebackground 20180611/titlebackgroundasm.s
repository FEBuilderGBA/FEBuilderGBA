...
ldr	r0,=0x0300302C @ FE8U -> =0x0300308C
ldrb	r1,[r0]
mov	r2,#0x80
orr	r1,r2
strb	r1,[r0]
...
ldr	r1,=0x06002E00
blh	0x08013008 @ FE8U -> 0x08012F50
ldr	r0,titlebackgroundimage
ldr	r1,=0x06000000
blh	0x08013008 @ FE8U -> 0x08012F50
...
mov	r1,#0
ldr	r2,=0x200
blh	0x08000D68 @ FE8U -> 0x8000DB8

@hide the other layers
@ldr	r0,=0x03003020 @FE8U -> 03003080
@ldr	r1,=0x1100
@strh	r1,[r0]

@empty the other layers
mov	r0,#1
blh	0x08001BC0 @FE8U -> 08001C4C
push	{r0}
mov	r0,#3
blh	0x08001BC0 @FE8U -> 08001C4C
mov	r1,r0
...
TSA:
mov	r0,#0
blh	0x08001BC0 @ FE8U -> 0x08001C4C
push	{r0}
mov	r0,#1
blh	0x08001BC0 @ FE8U -> 0x08001C4C
mov	r1,r0
...
End:
ldr	r0,=0x080ca60c + 1 @ FE8U-> =0x080C583D
bx	r0
