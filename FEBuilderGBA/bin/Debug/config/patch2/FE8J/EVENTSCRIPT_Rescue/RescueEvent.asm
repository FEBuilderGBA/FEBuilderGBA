...
push {r4-r5,lr}
ldr r2, =0x30004B4 @slot 1
ldrh r0,[r2]    @x coords
ldrh r1,[r2,#2] @y coords
bl GetUnitFromCoords
cmp r0,#0
beq End
ldr r5, =0x8019108 @turn deployment no into ram ptr
mov lr,r5
.short 0xf800
mov r4,r0 @save rescuer's ram
ldr r2, =0x30004B8 @slot 2
ldrh r0,[r2]
ldrh r1,[r2,#2]
bl GetUnitFromCoords
cmp r0,#0
...
ldr r3,=0x8018060 @rescue routine
mov  lr,r3
.short 0xf800
...
ldr r2,=0x202E4D4 @pointer to unit map
ldr r2,[r2]
lsl r1,#2 @y*4
