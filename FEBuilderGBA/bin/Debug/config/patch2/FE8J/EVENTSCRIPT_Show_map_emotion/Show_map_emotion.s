...
GetCoord:
	ldr r0, =0x030004DC       @FE8J (MemorySlot0B 主に座標が読みこまれるのに利用されます )
	ldrh r5, [r0,#0x0]        @X
	ldrh r6, [r0,#0x2]        @Y
...
Show:
	...
	ldr r0, =0x0202BCB8       @FE8J (gCurrentRealCameraPos )
	...
	ldr r0, [r4, #0x04]
	mov r1, #0x2
	blh 0x0800916c                @FE8J TCS_New Creates a new TCS TCS Pointer r0=Source ROMTCS, r1=OAM Index? idk
	...
	mov r0 ,r7
	mov r1, #0x0
	blh 0x08009408                @FE8J TCS_SetAnim Sets Anim of TCS void r0=TCS r1=Anim Index

	ldr r0, [r4, #0x08]
	mov r1, #0x3
	blh 0x08002bcc                @FE8J New6C 
	...
	blh  0x080D4EF4                     @FE8J 効果音を鳴らす関数 m4aSongNumStart r0=鳴らしたい音番号:SOUND
