...
push {r1}
push {r2}
@ldr r1,=#0x0203A4EC @ pointer to attacker data @FE8U
ldr r1, =#0x0203A4E8 @ pointer to attacker data @FE8J
cmp r1,r7
beq Compute
@ldr r1,=#0x0203A56C @ pointer to defender data @FE8U
ldr r1, =#0x0203A568 @ pointer to defender data @FE8J
cmp r1,r7
bne Return
...
.align 4
ReturnTo:
@.long 0x0802B9B0|1 @FE8U
.long  0x0802B8F8|1 @FE8J
