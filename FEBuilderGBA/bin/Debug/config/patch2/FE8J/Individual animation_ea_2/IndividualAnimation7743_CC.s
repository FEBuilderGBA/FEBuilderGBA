...
@壊すコードを再送 ただし、 r4 だけは検索で見つけたものを利用する
mov r0, r4
ldr r4,[r1, #0x4]    @アニメポインタ 発見した個別アニメのポインタに差し替える.
...
blh 0x0801911c       @GetROMClassStruct
str r0,[sp, #0x8]    @壊すコードの再送 spを触るので、スタック操作は禁止!
ldr r4, [r0, #0x34]   @Anime Pointer  見つからなかったのでディフォルト値
