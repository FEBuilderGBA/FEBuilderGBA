...
ldr r3, =0x0203E1EC @(gMapAnimStruct )
mov r1 ,r3
add r1, #0x58
ldrb r2, [r1, #0x0] @ pointer:0203E244
lsl r1 ,r2 ,#0x2
add r1 ,r1, r2
lsl r1 ,r1 ,#0x2
add r1 ,r1, r3
ldr r1, [r1, #0x0]  @ pointer:0203E1EC (gMapAnimStruct )
...
ldrb r1, [r1, #0x10]
lsl r1 ,r1 ,#0x4
ldr r2, =0x0202BCAC @(gMainLoopEndedFlag )
mov r3, #0xc
ldsh r2, [r2, r3]   @ pointer:0202BCB8 (gCurrentRealCameraPos )
sub r1 ,r1, r2

blh 0x08014b50   @PlaySpacialSoundMaybe
