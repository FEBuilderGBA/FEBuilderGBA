...
mov r3, #0
ldr r0, =#0x0203A4E8
blh 0x080168D0, r2 @ Equiped weapon of the attacker in r0
lsl r0, r0, #24
lsr r0, r0, #24
push { r0 }
@add r0, #0x48
...
ldr r0, =#0x0203A568
blh 0x080168D0, r2 @ Equiped weapon of the defender in r1
lsl r0, r0, #24
lsr r1, r0, #24
pop { r0 }
@add r1, #0x48
...
ldr r0, =0x203A53B @ Location for hit change for attacker
ldr r1, =0x203A5BB @ Location for hit change for defender
