...
Found:
ldrb r0, [r4, #0xa] @Table->PaletteID5
b    Exit
...
mov r1, #0x20
@blh 0x0805679c   @StoreSpellAnimPaletteOBJ	@{J}
blh 0x08055800   @StoreSpellAnimPaletteOBJ	@{U}

@ldr r3, =0x0805F198|1	@{J}
ldr r3, =0x0805E098|1	@{U}
bx r3
