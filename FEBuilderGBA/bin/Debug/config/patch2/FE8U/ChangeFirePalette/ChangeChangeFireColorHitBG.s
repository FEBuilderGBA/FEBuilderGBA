...
Found:
ldrb r0, [r4, #0x8] @Table->PaletteID3
b    Exit
...
mov r1, #0x20
@blh 0x080567e0   @StoreSpellAnimPaletteBG	@{J}
blh 0x08055844   @StoreSpellAnimPaletteBG	@{U}

@ldr r3, =0x0805EF24|1	@{J}
ldr r3, =0x0805DE24|1	@{U}
bx r3
