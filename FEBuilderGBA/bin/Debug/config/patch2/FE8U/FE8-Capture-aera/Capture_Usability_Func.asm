...
push	{r4-r6,r14}
ldr		r0,=$03004E50 ;FE8U	;CurrentCharPtr
ldr		r0,[r0]
...
ItemLoop:
	...
	mov		r1,#0x24
	mul		r0,r1
	ldr		r1,=$0801752C ;FE8U	;ItemTable
	ldr		r1, [r1]
	add		r0,r0,r1
	...
	ldr		r0,=$08016750 ;FE8U	;Weapon_Wield_Check
	mov		r14,r0
	mov		r0,r5
	mov		r1,r4
	@dcw	0xF800
	...
	mov	r5, #17
	ldsb	r5, [r2, r5]
	ldr	r1, =$02033F3C ;FE8U
	str	r0, [r1]
	ldr	r0, =$0202E4E4 ;FE8U
	ldr	r0, [r0]
	mov	r1, #0
ldr	r2, =$080197e4 ;FE8U
mov	lr, r2
@dcw	$F800
	
	ldr	r2, =$08024F70 ;FE8U
	mov	lr, r2
	@align 4
	ldr	r2, [adr]
	mov	r0, r4
